...
struct PersistenceController {
    ...
    static let preview: PersistenceController = {
        ...
        newPokemon.specialAttack = 69
        newPokemon.specialDefense = 69
        newPokemon.speed = 45
    ...
    init(inMemory: Bool = false) {
        ...
        if inMemory {
            ...
            container.persistentStoreDescriptions.first!.url = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.iOS.DexGroup")!.appending(path: "Dex.sqlite")
        }
